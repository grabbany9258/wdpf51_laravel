                    ...
                    <div class="container-fluid">
                        <div class="nk-header-wrap">
                            ...
                            <div class="nk-header-brand d-xl-none">
                                <a href="<?php echo route('admin'); ?>" class="logo-link">
                                    <img class="logo-light logo-img" src="assets/images/logo.png" srcset="assets/images/logo2x.png 2x" alt="logo">
                                    <img class="logo-dark logo-img" src="assets/images/logo-dark.png" srcset="assets/images/logo-dark2x.png 2x" alt="logo-dark">
                                </a>
                            </div><!-- .nk-header-brand -->
                                            ...
                                            <div class="card card-bordered card-full">
                                                ...
                                                <ul class="nk-activity">
                                                    <li class="nk-activity-item">
                                                        <div class="nk-activity-media user-avatar bg-success"><img src="assets/images/avatar/c-sm.jpg" alt=""></div>
                                                    ...
                                                    <li class="nk-activity-item">
                                                        <div class="nk-activity-media user-avatar bg-purple"><img src="assets/images/avatar/d-sm.jpg" alt=""></div>
                                                        <div class="nk-activity-data">
