                ...
                <li>
                  <div class="dropdown">
                    <a href="#" class="dropdown-toggle btn btn-white btn-dim btn-outline-light"
                      data-bs-toggle="dropdown"><em class="d-none d-sm-inline icon ni ni-calender-date"></em><span><span
                ...
                <div class="card-tools">
                  <div class="dropdown">
                    <a href="#" class="btn btn-primary btn-dim d-none d-sm-inline-flex"
                      data-bs-toggle="dropdown"><em class="icon ni ni-download-cloud"></em><span><span
                          class="d-none d-md-inline">Download</span> Report</span></a>
                    <a href="#" class="btn btn-icon btn-primary btn-dim d-sm-none" data-bs-toggle="dropdown"><em
          ...
          <div class="card card-bordered card-full">
            ...
            <ul class="nk-activity">
              <li class="nk-activity-item">
                <div class="nk-activity-media user-avatar bg-success"><img src="assets/images/avatar/c-sm.jpg"
                    alt=""></div>
              ...
              <li class="nk-activity-item">
                <div class="nk-activity-media user-avatar bg-purple"><img src="assets/images/avatar/d-sm.jpg"
                    alt=""></div>
                <div class="nk-activity-data">
