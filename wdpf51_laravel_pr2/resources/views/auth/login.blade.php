                    ...
                    <div class="nk-split nk-split-page nk-split-lg">
                        <div class="nk-split-content nk-block-area nk-block-area-column nk-auth-container bg-white">
                            ...
                            <div class="nk-block nk-block-middle nk-auth-body">
                                ...
                                <form action="{{ url('/login') }}" method="post" class="form-validate is-alter"
                                    autocomplete="off">
                                    @csrf
                    ...
                    <div class="modal-body modal-body-md">
                        ...
                        <div class="nk-country-region">
                            <ul class="country-list text-center gy-2">
                                ...
                                <li>
                                    <a href="#" class="country-item">
                                        <img src="assets/images/flags/canada.png" alt=""
                                            class="country-flag">
                                ...
                                <li>
                                    <a href="#" class="country-item">
                                        <img src="assets/images/flags/mexico.png" alt=""
                                            class="country-flag">
                                ...
                                <li>
                                    <a href="#" class="country-item">
                                        <img src="assets/images/flags/portugal.png" alt=""
                                            class="country-flag">
                                ...
                                <li>
                                    <a href="#" class="country-item">
                                        <img src="assets/images/flags/s-africa.png" alt=""
                                            class="country-flag">
