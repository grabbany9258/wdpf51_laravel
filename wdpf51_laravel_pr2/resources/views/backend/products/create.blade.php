...
@section('content')
    <div class="nk-content-body">
        ...
        <div class="nk-block">
                ...
                <form name="productForm" action="{{ url('/products') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <textarea name="product_details" value="{{ old('product_details') }}" id="product_details" cols="30" rows="6"
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="number" class="form-control" value="{{ old('product_price') }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="number" class="form-control" id="product_stock"
                                    value="{{ old('product_stock') }}" name="product_stock">
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        ...
                        <label class="form-label my-2" for="product_image">Product image</label>
            ...
            <div class="col-12">
                <button type="submit" class="btn btn-primary"><em class="icon ni ni-plus"></em><span class="my-2">Add
                        New</span></button>
            </div>
            </form>
        </div>
