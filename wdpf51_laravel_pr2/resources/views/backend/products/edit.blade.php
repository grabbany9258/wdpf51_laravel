        ...
        <div class="nk-block-head">
            <div class="nk-block-head-content">
                ...
                <div class="nk-block-des">
                    <p>Changes information and edit product.</p>
                </div>
            </div>
        </div><!-- .nk-block-head -->
        <div class="nk-block">
            <div class="row g-3">
                ...
                <form name="productForm" action="{{ route('products.update', $product->id) }}" method="post"
                                    ...
                                    @foreach ($cats as $cat)
                                        <option
                                            {{ old('product_category')
                                                ? (old('product_category') == $cat->id
                                                    ? 'selected'
                                                    : '')
                                                : ($product->product_category == $cat->id
                                                    ? 'selected'
                                                    : '') }}
                    ...
                    <div class="col-12">
                        ...
                        <img src="/product_photos/{{ $product->product_image }}" alt="" width="200">
                    </div>
            </div>
            <div class="col-12">
                <button type="submit" class="btn btn-primary"><em class="icon ni ni-plus"></em><span class="my-2">Update
                    </span></button>
            </div>
            </form>
        </div>
